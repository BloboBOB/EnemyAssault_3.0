...
vehspawn addAction ["<t size='1' shadow='2' color='#FFA000'>Spawn Vehicle</t> <img color='#FFA000' shadow='2' image='\A3\armor_f_gamma\MBT_01\Data\UI\Slammer_M2A1_Base_ca.paa'/>", "call ghst_fnc_spawnveh", ["veh_spawn",270], 6, true, true, "","alive _target"];
...
boatspawn addAction ["<t size='1' shadow='2' color='#FFA000'>Spawn Boat</t> <img color='#FFA000' shadow='2' image='\A3\boat_f_beta\SDV_01\data\ui\portrait_SDV_ca.paa'/>", "call ghst_fnc_spawnboat", ["boat_spawn",0], 6, true, true, "","alive _target"];
...
halo addAction ["<t size='1' shadow='2' color='#8904B1'>Move to Airport</t> <img color='#8904B1' shadow='2' image='\A3\air_f_beta\Heli_Transport_01\Data\UI\Heli_Transport_01_base_CA.paa'/>", {player setposatl [getmarkerpos "spawn_board_2" select 0,getmarkerpos "spawn_board_2" select 1,0.2];}, [], 5, false, true, "","alive _target"];
...
airspawn addAction ["<t size='1' shadow='2' color='#8904B1'>Move to Base</t> <img color='#8904B1' shadow='2' image='\A3\air_f_beta\Heli_Transport_01\Data\UI\Heli_Transport_01_base_CA.paa'/>", {player setposatl [getmarkerpos "Respawn_West" select 0,getmarkerpos "Respawn_West" select 1,0.2];}, [], 5, false, true, "","alive _target"];
